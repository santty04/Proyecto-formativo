    ...
    <div class="nav">
        <a href="dashboard-admin.php">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6 exit">
        ...
        <a href="matricula.php">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6 user-plus">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="" class="btn disabled" role="button" aria-disabled="true">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6 user">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="pagos.php">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6 cards">
                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo ($estudiante['apellidos_estudiante']); ?>
                            </td>
                            <td>
                                <?php echo ($estudiante['num_documento_estudiante']); ?>
                            </td>
                            <td>
                                <?php echo ($estudiante['fecha_nacimiento']); ?>
                            </td>
                            <td>
                                <?php echo ($estudiante['genero']); ?>
                            </td>
                            <td>
                                <?php echo ($estudiante['jornada']); ?>
                            </td>
                            <td>
                            ...
                            <?php if (isset($pagos)): ?>
                            <td align="center">
                                <?=($pagos ? '<b id="btnPagos_' . $estudiante['id'] . '" class="pagos" title="Ver pagos"
                                    data-id="' . $estudiante['id'] . '">+</b>' : ''); ?>
                            </td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        <li><a class="dropdown-item"
                                                href="ver.php?id=<?php echo $estudiante['id'] ?>"><i
                                                    class="fa fa-search"></i> Ver</a></li>
                                        <li><a class="dropdown-item"
                                                href="editar.php?id=<?php echo $estudiante['id'] ?>"><i
                                                    class="fa fa-pen"></i> Editar</a></li>
                                        <li><a class="dropdown-item bg-danger btn-inactive"
                                                data-id="<?php echo $estudiante['id'] ?>" href="inactivar:;"><i
                                                    class="fa-solid fa-eye-slash"></i> Inactivar</a></li>
                                    </ul>
                                </div>
                            </td>
                            <?php endif ?>
            ...
            <div class="col">
                <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <?php echo ($estudiante['nombre_acudiente']); ?>
                            </td>
                            <td>
                                <?php echo ($estudiante['apellidos_acudiente']); ?>
                            </td>
                            <td>
                                <?php echo ($estudiante['num_documento_acudiente']); ?>
                            </td>
                            <td>
                                <?php echo ($estudiante['direccion']); ?>
                            </td>
                            <td>
                                <?php echo ($estudiante['telefono']); ?>
                            </td>
        ...
        $(document).ready(function () {
            ...
            <?php unset($_SESSION[' message ']) ?>
                ...
                $('.btn-inactive').click(function (e) {
                    ...
                    Swal.fire({
                        title: 'Estás seguro?',
                        text: "El estudiante aparecerá inactivo!",
                        icon: 'warning',
